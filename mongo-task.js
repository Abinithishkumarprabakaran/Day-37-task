...
db.product.find({product_price: 492})
...
db.product.aggregate([{$group: {_id: "$product_price",products: { $push: "$product_name" },count: { $sum: 1 }}},{$match: {count: { $gt: 1 }}},{$project: {_id: 0,products: 1}}])
